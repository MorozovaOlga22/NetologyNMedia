...
class PostDaoImpl(private val db: SQLiteDatabase) : PostDao {
    companion object {
        ...
        CREATE TABLE ${PostColumns.TABLE} (
            ...
            ${PostColumns.COLUMN_REPOSTS_COUNT} INTEGER NOT NULL DEFAULT 0,
    ...
    object PostColumns {
        ...
        const val COLUMN_REPOSTS_COUNT = "repostsCount"
    ...
    override fun save(post: Post): Post {
        val values = ContentValues().apply {
            if (post.id != 0L) {
                ...
                put(PostColumns.COLUMN_REPOSTS_COUNT, post.repostsCount)
                put(PostColumns.COLUMN_VIEWINGS_COUNT, post.viewingsCount)
    ...
    private fun map(cursor: Cursor): Post {
        with(cursor) {
            return Post(
                ...
                repostsCount = getInt(getColumnIndexOrThrow(PostColumns.COLUMN_REPOSTS_COUNT)),
